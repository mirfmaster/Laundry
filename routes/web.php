...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('laporan/pembelian/cetak', 'PembelianController@cetak')->name('cetakpembelian');
    Route::post('laporan/laundry/cetak', 'PemakaianController@cetak')->name('cetaklaundry');
